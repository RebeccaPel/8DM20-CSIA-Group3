...
for epoch in range(N_EPOCHS):
    ...
    scheduler.step(epoch)  # step the learning step scheduler
    ...
    with torch.no_grad():
        generated_images = vae_model.decode(torch.FloatTensor(noise))

    # TODO: generate images and display
    image_grid = make_grid(generated_images, noise)
    plt.show()
