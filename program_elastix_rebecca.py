...
training_data_path = r'C:/Users/20192157/OneDrive - TU Eindhoven/Documents/Master/8DM20 Capita selecta in medical image analysis/TrainingData'
...
if __name__ == "__main__":
    ...
    fixed_image_path = training_data_path + "/p102/mr_bffe.mhd"
    fixed_image_seg_path = training_data_path + "/p102/prostaat.mhd"
    moving_image_path = training_data_path + "/p120/mr_bffe.mhd"

    image_1 = sitk.ReadImage(fixed_image_path)
    image_1_seg = sitk.ReadImage(fixed_image_seg_path)
    ...
    image_2 = sitk.ReadImage(moving_image_path)
